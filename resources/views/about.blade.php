					...
					<div class="container">
						<div class="row mt-5">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1 class="text-9 font-weight-bold">About CAANS</h1>
							</div>
							<div class="col-md-12 align-self-center order-1">
								<ul class="breadcrumb breadcrumb-light d-block text-center">
									<li><a href="#">Home</a></li>
									<li class="active">About CAANS</li>
								</ul>
							</div>
						</div>
					</div>
								...
								<div class="col-md-9 mx-md-auto">
									<div class="overflow-hidden mb-3">
										<h1 class="word-rotator slide font-weight-bold text-8 mb-0 appear-animation" data-appear-animation="maskUp">
											<span>We are Continental Association of Africa Neurosurgical Societies </span>
										</h1>
									</div>
									<div class="overflow-hidden mb-3">
										<p class="text-justify text-dark" style="letter-spacing: 0.8px; line-height: 2.9">
											The goal of this Association is to enhance neurological surgery in all of its manifestations in order to improve the neurological health of those residing on the African continent.Aiding in the interchange and diffusion of knowledge and ideas in the field of neurological surgery, and facilitating the personal and professional interaction and development of neurological surgeons throughout Africa
										</p>
									</div>
								</div>
							</div>
