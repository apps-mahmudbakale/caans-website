					...
					<div class="container">
						<div class="row">
							<div class="col-md-8 order-2 order-md-1 align-self-center p-static">
								<h1><strong>Member Society {{strtoupper($country->name)}}</strong></h1>
                                ...
                                <span class="thumb-info-wrapper">
                                    <a href="">
                                        ...
                                        <span class="thumb-info-title">
                                            <span class="thumb-info-inner">{{strtoupper($member->name)}}</span>
                                             <span class="thumb-info-type">{{$member->email}}</span>
                                        </span>
                                    </a>
                                </span>
                            </span>
