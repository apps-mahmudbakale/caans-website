                                ...
                                <span class="thumb-info-wrapper">
                                    <a href="">
                                        ...
                                        <span class="thumb-info-title">
                                            <span class="thumb-info-inner">Samuel Ohaegbulam</span>
                            ...
                            <span class="thumb-info thumb-info-hide-wrapper-bg mb-4">
                                <span class="thumb-info-wrapper">
                                    <a href="">
                                        <img src="{{asset('images/avatar.jpg')}}" class="img-fluid" alt="">
                                        <span class="thumb-info-title">
                                            <span class="thumb-info-inner">Abdelsalam El Khamlichi</span>
                                        </span>
                                    </a>
                                </span>
                            ...
                            <span class="thumb-info thumb-info-hide-wrapper-bg mb-4">
                                <span class="thumb-info-wrapper">
                                    <a href="">
                                        <img src="{{asset('images/avatar.jpg')}}" class="img-fluid" alt="">
                                        <span class="thumb-info-title">
                                            <span class="thumb-info-inner">Mike Du Treveau</span>
                                        </span>
                                    </a>
                                </span>
